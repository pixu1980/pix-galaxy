...
This log records the significant architectural decisions for pix-galaxy. Each ADR is a short Nygard-format document (Context / Decision / Consequences) that captures *what* was decided and *why*.
