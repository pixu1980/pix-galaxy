...
Thanks for contributing to @pix-galaxy/pix-accent-color-selector.
...
Docs source markdown lives in src/docs/content/. Site source lives in src/docs/. The component source itself lives in src/components/AccentColorSelector/.
