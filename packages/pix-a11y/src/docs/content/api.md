...
## Component class: `PixA11y`

### Properties

| Property      | Type                   | Description                                                              |
| ------------- | ---------------------- | ------------------------------------------------------------------------ |
| `preferences` | `A11yPreferences` | The currently active preferences (alias `DisplayPreferences` deprecated) |
...
const el = document.querySelector('pix-a11y');
