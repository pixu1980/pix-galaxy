...
@pix-galaxy/pix-a11y is a browser-first display preferences popover Web Component designed for the pix-galaxy suite. It provides an accessible popover panel for adjusting color scheme, accent color, accessibility options, typography, and corner radius preferences - all persisted to localStorage and applied to the document in real time.

Live docs site: https://pixu1980.github.io/pix-a11y/
...
- Persists all preferences in `localStorage` under `pix-a11y`.
...
| Symbol                              | Description                                 |
| ----------------------------------- | ------------------------------------------- |
| `PixA11y`                      | Component class (extends `HTMLElement`)     |
...
- Persists preferences in `localStorage` under `pix-a11y`.
