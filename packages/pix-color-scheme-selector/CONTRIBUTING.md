...
Thanks for contributing to @pix-galaxy/pix-color-scheme-selector.
...
Docs source markdown lives in src/docs/content/. Site source lives in src/docs/. The component source itself lives in src/components/ColorSchemeSelector/.
