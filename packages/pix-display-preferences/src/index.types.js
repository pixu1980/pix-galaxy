 ...
 */
export class PixDisplayPreferences extends HTMLElement {
...
/**
 * @type {Readonly<DisplayPreferences>}
 */
...
export const ACCESSIBILITY_OPTIONS = Object.freeze([
  {
    ...
    description: 'Minimize motion-heavy interactions, animations, transitions, and smooth scrolling.',
    label: 'Reduce Motion',
    name: 'reduceMotion',
  },
  {
 ...
 */
export const FONT_SCALE_OPTIONS = Object.freeze(['75%', '80%', '90%', '100%', '110%', '120%', '125%']);

/**
 * @type {string}
 */
export const STORAGE_KEY = 'pix-display-preferences';

/**
 * @param {DisplayPreferences} preferences
 * @returns {DisplayPreferences}
 */
