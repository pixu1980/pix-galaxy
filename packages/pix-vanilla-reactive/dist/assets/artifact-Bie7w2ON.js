...
`,i=`/**
 * FILE: _cyberpunk.css
 * USAGE: Stylesheet for packages/pix-highlighter/src/components/PixHighlighter/styles/themes/_cyberpunk.css.
 * SCOPE: File-local selectors and pix-galaxy design tokens.
 */
@layer pix-galaxy {
  @layer pix-highlighter {
    @layer themes {
...
`,a=`/**
 * FILE: _darcula.css
 * USAGE: Stylesheet for packages/pix-highlighter/src/components/PixHighlighter/styles/themes/_darcula.css.
 * SCOPE: File-local selectors and pix-galaxy design tokens.
 */
@layer pix-galaxy {
  @layer pix-highlighter {
...
`,o=`/**
 * FILE: _default.css
 * USAGE: Stylesheet for packages/pix-highlighter/src/components/PixHighlighter/styles/themes/_default.css.
 * SCOPE: File-local selectors and pix-galaxy design tokens.
 */
@layer pix-galaxy {
  @layer pix-highlighter {
...
`,s=`/**
 * FILE: _prettylights.css
 * USAGE: Stylesheet for packages/pix-highlighter/src/components/PixHighlighter/styles/themes/_prettylights.css.
 * SCOPE: File-local selectors and pix-galaxy design tokens.
 */
@layer pix-galaxy {
  @layer pix-highlighter {
...
`,c=`/**
 * FILE: _prism.css
 * USAGE: Stylesheet for packages/pix-highlighter/src/components/PixHighlighter/styles/themes/_prism.css.
 * SCOPE: File-local selectors and pix-galaxy design tokens.
 */
@layer pix-galaxy {
  @layer pix-highlighter {
...
`,l=`/**
 * FILE: _monokai.css
 * USAGE: Stylesheet for packages/pix-highlighter/src/components/PixHighlighter/styles/themes/_monokai.css.
 * SCOPE: File-local selectors and pix-galaxy design tokens.
 */
@layer pix-galaxy {
  @layer pix-highlighter {
...
`,u=`/**
 * FILE: _nord.css
 * USAGE: Stylesheet for packages/pix-highlighter/src/components/PixHighlighter/styles/themes/_nord.css.
 * SCOPE: File-local selectors and pix-galaxy design tokens.
 */
@layer pix-galaxy {
  @layer pix-highlighter {
    ...
    [data-theme-list] {
      ...
      [data-theme-option] {
        ...
        &:where(:hover, [data-selected]) {
          border-color: color-mix(in srgb, var(--pix-highlighter--fg) 40%, transparent);
