// src/components/PixHighlighter/styles/pix-highlighter.css
var pix_highlighter_default = '@import "./_core.css" layer(components.pix-highlighter);\n@import "./states/_states.css" layer(components.pix-highlighter);\n';
...
// src/components/PixHighlighter/pix-highlighter.consts.js
var DEFAULT_VARIANT = "default";
var SUPPORTED_VARIANTS = ["default", "outlined"];
var ROOT_PART = "root";
var CONTENT_PART = "content";

// src/components/PixHighlighter/pix-highlighter.utils.js
function normalizeVariant(value) {
  return SUPPORTED_VARIANTS.includes(String(value)) ? (
    /** @type {import('./pix-highlighter.consts.js').PixHighlighterVariant} */
    value
  ) : DEFAULT_VARIANT;
}
...
// src/components/PixHighlighter/pix-highlighter.attributes.js
var pix_highlighter_attributes_default = {
  /**
   * @this {HTMLElement}
...
// src/components/PixHighlighter/pix-highlighter.events.js
var pix_highlighter_events_default = {};
...
// src/components/PixHighlighter/pix-highlighter.template.js
...
// src/components/PixHighlighter/pix-highlighter.js
var PixHighlighter = class extends HTMLElement {
  static attributes = pix_highlighter_attributes_default;
  static events = pix_highlighter_events_default;
  static styles = pix_highlighter_default;
  static {
