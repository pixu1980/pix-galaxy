...
Thanks for contributing to @pix-galaxy/pix-highlighter.
...
Docs source markdown lives in src/docs/content/. Site source lives in src/docs/. The component source itself lives in src/components/PixHighlighter/.
...
- Keep the theme matrix coherent: when you add a new semantic token color, define it across every shipped theme.
