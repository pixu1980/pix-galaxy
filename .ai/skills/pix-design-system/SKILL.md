...
- foundations for typography, spacing, radii, elevations, and colors
...
3. Extras cover reset, layout, component aliases, and helpers.
...
6. Examples remain consultable and aligned with current token names.
7. Validation commands pass or failures are reported with exact output.
