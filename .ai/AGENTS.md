# pix-galaxy – Codex Agent Instructions

This project follows the rules and conventions defined in `.ai/instructions/`.
...
- @pix-template-engine.instructions: see `.ai/instructions/pix-template-engine.instructions.md`
