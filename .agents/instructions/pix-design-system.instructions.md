...
- Keep `assets/design-system/shared/` as the only authoring source inside the skill, but always materialize the full CSS tree into installed app/package outputs. Generated targets must not import back into `.github/`, `.agents/`, or other skill-relative paths.
