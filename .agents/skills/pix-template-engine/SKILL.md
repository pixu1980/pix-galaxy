...
description: 'Use when integrating or maintaining template-engine workflows, static HTML generation, SSG, SSR, HTML rendering pipelines, includes, extends, blocks, server-side template rendering, engine.html, or tagged template literals.'
---
...
1. Install engine in target project:
   - `node ./.agents/skills/pix-template-engine/scripts/install-template-engine.mjs --target "<project-root>" --dest "src/template-engine" --with-examples`
